<!-- Script to allow linking to other Oscar pages for active patient for Oscar15 build 855 -->
...
window.open("../oscarResearch/oscarDxResearch/setupDxResearch.do?demographicNo="+RegExp.$1+"&providerNo=");
}
