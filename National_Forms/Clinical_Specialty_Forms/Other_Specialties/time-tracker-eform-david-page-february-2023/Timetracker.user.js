...
window.addEventListener("load",function(){
   ...
   if ((/billing/i.test(locator))||(/CaseManagementEntry/i.test(locator))) {
     ...
     if (startTime) {
      ...
      input1.setAttribute("style", "font-size:16px;position:fixed;top:600px;left:20px;background-color: yellow");
    ...
    $("input[name='xml_diagnostic_detail1']").focus();
     ...
     if (istartTime) {
      ...
      input2.setAttribute("style", "font-size:16px;position:fixed;top:640px;left:20px;background-color: yellow");
     ...
     if (astartTime) {
      ...
      input3.setAttribute("style", "font-size:16px;position:fixed;top:680px;left:20px;background-color: yellow");
   ...
   if (/billRegion=BC/i.test(locator)) {
         ...
         BT.value = "Toggle";
         BT.onclick = BTT;
         BT.setAttribute("style", "font-size:12px;position:fixed;top:94px;left:0px; background-color: green");
