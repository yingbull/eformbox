 ...
 * As per K Yap
 * file name JsonFix_V9_Apr11_2019.js; updated JsonFix_V11_2019.js
 ...
 */
		...
		/****************************
			...
			Separate with a linefeed + asterisk; does not work in build 854 as there are no comma separators.
		****************************/
				if (document.getElementById("Social").innerHTML == '') {
						document.getElementById("Social").value = '';
				}
			document.getElementById("Social").innerHTML = '* ' + document.getElementById("Social").innerHTML;
			document.getElementById("Social").innerHTML = document.getElementById("Social").innerHTML.replace(/\., /g , '\.\n* ');
			document.getElementById("Social").innerHTML = document.getElementById("Social").innerHTML.replace(/\;, /g , '\.\n* ');
			document.getElementById("Social").innerHTML = document.getElementById("Social").innerHTML.replace(/\?, /g , '\?\n* ');
			
				if (document.getElementById("Reminders").innerHTML == '') {
						document.getElementById("Reminders").value = '';
				}
			document.getElementById("Reminders").innerHTML = '* ' + document.getElementById("Reminders").innerHTML;
			document.getElementById("Reminders").innerHTML = document.getElementById("Reminders").innerHTML.replace(/\., /g , '\.\n* ');
			document.getElementById("Reminders").innerHTML = document.getElementById("Reminders").innerHTML.replace(/\;, /g , '\.\n* ');
			document.getElementById("Reminders").innerHTML = document.getElementById("Reminders").innerHTML.replace(/\?, /g , '\?\n* ');
