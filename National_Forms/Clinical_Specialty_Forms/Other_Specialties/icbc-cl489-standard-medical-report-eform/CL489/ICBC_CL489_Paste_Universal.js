 ...
 * modified as per David Page to be compatible with Grease Monkey scripts - specifically Billy Lin's eMail/text script
...
/* Allow Copy to Encounter with proper formatting */
		function PasteToEncounter(notes, header) {
			try {
    			...
    			//var textAreaId = win.document.getElementsByClassName('txtArea')[0];
